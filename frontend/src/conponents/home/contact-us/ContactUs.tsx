...
function ContactUs() {
  return (
    ...
    >
      <h2 className="absolute montserrat top-8 md:text-black left-1/2 -translate-x-[50%] text-center heading3 ">
        CONTACT US
      </h2>
      ...
      <Link to='/contact-us' className="grid place-items-center">
        <button className="text-white bg-black border-2 border-black font-bold montserrat px-8 mt-8 cursor-pointer hover:scale-105 trans py-1.5 rounded-full">
          Contact Us
        </button>
      </Link>
    </section>
