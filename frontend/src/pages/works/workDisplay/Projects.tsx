...
function Works() {
  ...
  function handleActiveTabs({ isActive }: { isActive: boolean }) {
    ...
    return clsx("rounded-lg trans snap-center px-6 py-3", active);
  }
  ...
  return (
    ...
    >
      <div className=" text-center lg:w-[80%] mx-auto  ">
        <h1 className=" text-4xl md:text-5xl font-bold bg-gradient-to-r mb-2 from-accent via-pink-400 to-blue-400 bg-clip-text text-transparent montserrat text-center">
          OUR PROJECTS
        </h1>
