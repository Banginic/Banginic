  ...
  return (
    <section className="min-h-screen relative">
      ...
      <div className=" mb-12 lg:flex mt-8 gap-4 lg:justify-around trans">
        <div
          className={`border bg-gradient-to-br from-pink-200/30 to-white/20 backdrop-blur-sm shadow-accent/20 shadow-xl  border-gray-200 dark:border-gray-900 rounded-lg p-4 w-sm md:w-lg lg:w-2xl mx-auto ${
            showForm ? "lg:mx-0" : ""
          } mt-8`}
        >
          ...
          <div className="mb-4 px-4">
            <h3 className="text-pink-100">Posted Date</h3>
          ...
          <div className="mb-4 px-4">
            <h3 className="text-pink-100">Last Date</h3>
          ...
          <div className="mb-4 px-4">
            <h3 className="text-pink-100">Location</h3>
            <p>{data?.job?.location}</p>
          </div>
          <div className="mb-4">
            <h3 className="text-pink-100 px-4">Job Desciption</h3>
            <p className="bg-gray-800/50 p-4 rounded-lg mt-1 borde border-gray-500 dark:bg-gray-800/20 text-white dark:text-neutral-500">
